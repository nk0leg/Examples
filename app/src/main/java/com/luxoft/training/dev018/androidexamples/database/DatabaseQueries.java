...
public class DatabaseQueries extends AppCompatActivity implements OnClickListener {

    final String TAG = "DatabaseQueries";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_db_queries);
        ...
        if (c.getCount() == 0) {
            ...
            for (int i = 0; i < 10; i++) {
                ...
                Log.d(TAG, "id = " + db.insert("mytable", null, cv));
            }
        }
        c.close();
        dbHelper.close();
    ...
    class DBHelper extends SQLiteOpenHelper {
        ...
        public DBHelper(Context context) {
            super(context, "DBQueries", null, 1);
        }
