package com.luxoft.training.dev018.androidexamples.contentprovider;
...
public class ContentProviderActivity extends AppCompatActivity {
    final String TAG = "ContentProviderAct";

    final Uri CONTACT_URI = Uri
            .parse("content://com.luxoft.training.dev018.androidexamples.contentprovider.AddressBook/contacts");
    ...
    public void onClickError(View v) {
        Uri uri = Uri.parse("content://com.luxoft.training.dev018.androidexamples.contentprovider.AddressBook/phones");
        try {
